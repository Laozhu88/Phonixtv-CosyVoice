...
class RainfallCosyVoiceService:
    ...
    def save_history(self, payload: dict) -> dict:
        record = {
            ...
            "machine_translated_text": payload.get("machine_translated_text") or payload.get("translated_text") or "",
            ...
            "broadcast_audio_url": payload.get("broadcast_audio_url") or "",
            "broadcast_filename": payload.get("broadcast_filename") or "",
            "broadcast_spec": payload.get("broadcast_spec") or "",
            "quality_check": payload.get("quality_check") if isinstance(payload.get("quality_check"), dict) else None,
